...
import HERO_URL from '../../assets/9.png';
// import { Link } from 'react-router-dom';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="flex flex-col mt-16">
            ...
            >
              ...
              Elevate your space with top-notch furniture—stylish, comfortable, and budget-friendly!
              Explore exclusive deals on a curated range of elegant and functional pieces, from chic
              sofas to exquisite dining sets. Your perfect home furniture is just a click away!
            </motion.p>
            <motion.div
          ...
          >
            <img className="h-[100%] w-[200%]" src={HERO_URL} alt="" />
          </motion.div>
        </div>
      </div>
    </div>
