...
const AddProduct = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      formData.append('width', formik.values.width);
        ...
        <div className="w-3/4">
          <form onSubmit={formik.handleSubmit}>
            ...
            <label htmlFor="brand" className="tracking-wider mb-3">
              ...
              <div className="flex">
                {/* <span className="flex items-center justify-center border  border-r-0 py-2 px-3  text-black"> */}
                {/* </span> */}
                <input
                  type="number"
                  name="dimension"
